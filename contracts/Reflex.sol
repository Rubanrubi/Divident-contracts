...
// main contract
contract ReflexFinance is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "Reflex Finance";
    ...
    constructor(
        ...
        address antiBot_, // 0x8efdb3b642eb2a20607ffe0a56cfeff6a95df002
    ...
    function setAntiBot(address _antiBot, bool _enable) external authorized {
    ...
    function setStakeAddress(address _staking, bool _enable) external authorized {
