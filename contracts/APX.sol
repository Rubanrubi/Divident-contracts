...
contract ApolloCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Apollo Coin";
    string constant _symbol = "APX";
...
//        emit Transfer(sender, recipient, amount);
    ...
    function launch() public authorized {
        require(launchedAt == 0, "Apollo Coin has already launched towards the moon!");
